...
function SignupForm() {
  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit)}>
      ...
      {/* getValues will helps us to get the previous values of the form */}
    <FormRow label="Repeat password" error={errors?.passwordConfirm?.message}>
        <Input type="password" id="passwordConfirm" disabled={isLoading} {...register('passwordConfirm', {required: 'This field is required', validate: (value) => value === getValues().password || 'Password need to match',
